...
#' @param pathToDat  pathway to blast file, if exists
...
get_taxa<-function(pathToTaxa,pathToGnavus="None"){
  ...
  print("gnavus successfully added with the following annotation:")
  print(table(taxaobj$longname.gen[gna.index]))
