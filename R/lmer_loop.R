...
#' @param random.var variable to be used for random effect
#'
...
lmer_loop<-function(keyobj, datobj,transform="log2", fixed.vars, vars.to.scale="none",random.var) {
   if (transform=="log2") {
